...
class IndoorControl {
    ...
    onAdd(map: MapGL | MapGLWithIndoor): any {
    ...
    _setSelected(level: Level | null): any {
    ...
    _createLevelButton(container: HTMLElement, level: Level): any {
